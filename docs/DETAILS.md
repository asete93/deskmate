...
설치·용도 요약은 [README](../README.md)로. 이 문서는 보안·개념·기능·운영의 전체 설명입니다.
...
| | |
|---|---|
| ![채팅](screenshots/chat-room.png) | ![주석 리뷰](screenshots/review.png) |
| 채팅방 — 위임 과정·REQ 경계·토큰이 한 흐름에 | 주석 리뷰 — 결과물에 핀을 꽂고 텍스트를 직접 수정 |
| ![조직도](screenshots/org-chart.png) | ![결재](screenshots/approvals.png) |
